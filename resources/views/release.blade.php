...
<head>
    ...
    <style>
        body {
            background-image: url({{ asset('img/release.jpg') }});
    ...
    <section class=" relative">
            <div class="w-full md:px-16 px-10 md:pt-16 pt-10 pb-10  rounded-2xl flex-col justify-end items-center lg:gap-28 md:gap-16 gap-10 inline-flex">
                <div class="flex-col justify-end items-center lg:gap-16 gap-10 flex">
                    <div class="bg-white rounded-lg opacity-75">
                        <img src="{{ asset('img/logo.png') }}" alt="pagedone logo image" class="object-cover w-40">
                    </div>
                    <div class="flex-col justify-center items-center gap-10 flex border bg-black p-10 rounded-lg opacity-75">
                        ...
                        <div class="w-full flex-col justify-center items-center gap-5 flex">
                            <h6 class="text-center text-emerald-400 text-base font-semibold leading-relaxed">Launched Date: December 23, 2024</h6>
                            <div class="justify-center items-center gap-2.5 flex sm:flex-row flex-col">
                                ...
                                <a href="/release" class="sm:w-fit w-full px-3.5 py-2 bg-emerald-400 hover:bg-emerald-600 transition-all duration-700 ease-in-out rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
                ...
                <p class="text-center text-gray-500 text-sm font-normal leading-snug">Get in touch with us: <a href="" class="hover:text-gray-100 transition-all duration-700 ease-in-out"> admin@bukuwaktu.com</a></p>
            </div>
    </section>
<!--Javascript-->
<script>
    // count-down timer
    let dest = new Date("dec 23, 2024 15:11:59").getTime();
    let x = setInterval(function () {
      let now = new Date().getTime();
      let diff = dest - now;
      // Check if the countdown has reached zero or negative
      if (diff <= 0) {
        // Redirect to the "/" route when the countdown is finished
