...
<html lang="en">
  ...
  <body>
    ...
    <div class="flex w-screen h-screen text-gray-700">
      ...
      >
        <a
          class="flex items-center justify-center flex-shrink-0 w-full h-16 bg-emerald-500"
          href="/"
        >
        <img src="{{ asset('img/logosquare.png') }}" alt="" class="w-10 ">
      ...
      <div class="flex flex-col w-56 border-r border-gray-300">
        <button class="relative text-sm focus:outline-none group">
          <div
            class="flex items-center justify-between w-full h-16 px-4 border-b border-gray-300 hover:"
          >
        ...
        <div class="flex flex-col flex-grow p-4 overflow-auto">
            <x-sidebar-admin-link :active="request()->is('dashboard')" href="{{ route('dashboard') }}">
                Dashboard
            </x-sidebar-admin-link>

            <x-sidebar-admin-link :active="request()->is('audit-user')" href="{{ route('audit-user') }}">
                Audit User
            </x-sidebar-admin-link>

            <x-sidebar-admin-link :active="request()->is('audit-postingan')" href="{{ route('audit-postingan') }}">
                Audit Postingan
            </x-sidebar-admin-link>

            <x-sidebar-admin-link :active="request()->is('audit-audiobook')" href="{{ route('audit-audiobook') }}">
                Audit Audiobook
            </x-sidebar-admin-link>

            <x-sidebar-admin-link :active="request()->is('audit-komentar')" href="{{ route('audit-komentar') }}">
                Audit Komentar
            </x-sidebar-admin-link>

            <x-sidebar-admin-link :active="false" href="{{ route('logout') }}">
                Log Out
            </x-sidebar-admin-link>
        </div>
      ...
      <div class="flex flex-col flex-grow">
        ...
        <div class="flex-grow p-6 overflow-auto bg-gray-200">
            <div class="grid grid-cols-3 gap-6 h-full">
                <div class="col-span-1 bg-white border border-gray-300 h-full">
                    <ul>
                ...
                <div class="col-span-2 bg-white border border-gray-300 h-full">
                    <ul>
