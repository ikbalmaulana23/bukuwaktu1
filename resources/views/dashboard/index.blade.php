...
<body class="relative bg-yellow-50 overflow-hidden max-h-screen">
    ...
    <div class="flex flex-col justify-between h-full">
      <div class="flex-grow">
        <div class="px-4 py-6 text-center border-b">
          <h1 class="text-xl font-bold leading-none">Bukuwaktu <span>Dashboard</span></h1>
        </div>
        <div class="p-4">
          <ul class="space-y-1">
            <li>
  ...
  <main class="ml-60 p-16 max-h-screen overflow-auto">
    <div class="px-6 py-8 border bg-white">
